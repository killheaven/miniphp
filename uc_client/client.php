...
function uc_user_register($username, $password, $email, $usernumber, $realname, $usertype, $idnum='', $questionid = '', $answer = '', $regip = '') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password, 'email'=>$email, 'usernumber'=>$usernumber, 'realname'=>$realname, 'usertype'=>$usertype, 'idnum'=>$idnum, 'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip));
}
...
function uc_user_edit($username, $oldpw, $newpw, $email, $usernumber, $realname, $usertype, $ignoreoldpw = 0, $questionid = '', $answer = '') {
	return call_user_func(UC_API_FUNC, 'user', 'edit', array('username'=>$username, 'oldpw'=>$oldpw, 'newpw'=>$newpw, 'email'=>$email, 'usernumber'=>$usernumber, 'realname'=>$realname, 'usertype'=>$usertype, 'ignoreoldpw'=>$ignoreoldpw, 'questionid'=>$questionid, 'answer'=>$answer));
}
...
function uc_user_checketrueinfo($email = '', $usernumber = '', $realname = '', $usertype = '', $idnum = '') {
	return call_user_func(UC_API_FUNC, 'user', 'check_userinfo', array('email'=>$email, 'usernumber'=>$usernumber, 'realname'=>$realname, 'usertype'=>$usertype, 'idnum'=>$idnum));
}
